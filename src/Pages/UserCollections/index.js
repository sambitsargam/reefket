    ...
    const ListOfAllCollections = () => {
        return (<div><div className="grid grid-cols-3 gap-4">
            ...
            {fetchedCollections < totalCollectionsN ? <button
                ...
                type="button"
                className=" mx-auto mt-3 inline-flex justify-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
