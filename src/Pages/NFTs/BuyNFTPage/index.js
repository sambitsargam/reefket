        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div>
                ...
                <button
                    ...
                    class="block w-48 truncate text-md mx-auto px-4 py-2 rounded text-white  font-bold hover:text-white mt-4 hover:bg-red-800 bg-blue-500 lg:mt-0">Buy NFT</button>
